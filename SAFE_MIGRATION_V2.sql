-- ============================================================================
-- WARD MANAGEMENT SYSTEM - SAFE MIGRATION V2 (SIMPLIFIED & RELIABLE)
-- ============================================================================
-- This script is SAFE to run on a shared Supabase project
-- Run each section ONE AT A TIME to see any errors
-- ============================================================================

-- ============================================================================
-- SECTION 1: Create hospital_wards table
-- ============================================================================
-- Run this first
...
-- ============================================================================
-- SECTION 2: Create ward_patients table
-- ============================================================================
-- Run this second (requires hospital_wards to exist)
...
-- ============================================================================
-- SECTION 4: Create patient_forms table
-- ============================================================================
-- Run this fourth (requires ward_patients to exist)
...
-- ============================================================================
-- SECTION 5: Create ot_forms table
-- ============================================================================
-- Run this fifth (requires ward_patients to exist)
...
FROM hospital_wards
UNION ALL
SELECT 'ward_patients', COUNT(*) FROM ward_patients
UNION ALL
SELECT 'staff', COUNT(*) FROM staff
UNION ALL
SELECT 'doctors', COUNT(*) FROM doctors
UNION ALL
SELECT 'patient_forms', COUNT(*) FROM patient_forms
UNION ALL
SELECT 'ot_forms', COUNT(*) FROM ot_forms;
